        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center min-h-[80vh]">
            ...
            >
              ...
              >
                ...
                <span className="relative">
                  ...
                  <motion.div
                    className="absolute -bottom-1 sm:-bottom-2 left-0 right-0 h-2 sm:h-3 bg-brand-green/20 rounded-full"
                    initial={{ scaleX: 0 }}
                    animate={{ scaleX: 1 }}
              ...
              {/* Stats */}
              <motion.div
                className="grid grid-cols-3 gap-4 sm:gap-6 md:gap-8 py-4 sm:py-6 md:py-8"
                initial={{ opacity: 0, y: 30 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              >
                {[
                  ...
                  >
                    <div className="text-xl sm:text-2xl md:text-3xl font-bold text-brand-green mb-1">
                      {stat.number}
                    </div>
            ...
            >
              ...
              <motion.div
                className="relative w-full h-[300px] sm:h-[400px] md:h-[500px] lg:h-[600px] rounded-2xl sm:rounded-3xl overflow-hidden shadow-2xl"
              ...
              >
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-white font-semibold text-sm sm:text-base md:text-lg drop-shadow-lg">
              ...
              {/* Floating Cards */}
              <motion.div
                className="absolute -top-3 -right-3 sm:-top-6 sm:-right-6 bg-white rounded-xl sm:rounded-2xl shadow-xl p-3 sm:p-6 border border-gray-100"
              ...
              >
                <div className="flex items-center space-x-2 sm:space-x-3">
                  <div className="w-8 h-8 sm:w-12 sm:h-12 bg-brand-green rounded-full flex items-center justify-center">
              ...
              <motion.div
                className="absolute -bottom-3 -left-3 sm:-bottom-6 sm:-left-6 bg-white rounded-xl sm:rounded-2xl shadow-xl p-3 sm:p-6 border border-gray-100"
                initial={{ opacity: 0, y: 20, rotate: 5 }}
                animate={{ opacity: 1, y: 0, rotate: 0 }}
                ...
                <div className="flex items-center space-x-2 sm:space-x-3">
                  <div className="flex">
                    {[...Array(5)].map((_, i) => (
                      <Star
                        key={i}
                        className="w-3 h-3 sm:w-5 sm:h-5 text-yellow-400 fill-current"
                      />
                    ))}
                  </div>
                  <div>
